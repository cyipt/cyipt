...
author: "Robin Lovelace, Leeds Institute for Data Analytics and ITS, `@robinlovelace`"
date: "Presented in Parliament for the APPCG, `r Sys.Date()`."
output:
...
> - Phase II of CyIPT: make publicly accessible
> - Crowd-sourcing (active): Cycle safety, a 'Space for Cycling Toolkit'
> - Crowd-sourcing (passive): updated OD data, all modes, road surface quality data (See.Sense data shown below - topic of new PhD)
...
> - Contact: r.lovelace@leeds.ac.uk or `@robinlovelace`
